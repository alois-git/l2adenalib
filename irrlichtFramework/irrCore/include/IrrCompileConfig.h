...
#ifdef IRRLICHTFRAMEWORK_EXPORTS
#define IRRCORE_EXPORTS
#define IRRTHREAD_EXPORTS
...
#define IRRCORE_API __declspec(dllexport)
#else
#define IRRCORE_API __declspec(dllimport)
#endif // IRRCORE_EXPORTS
